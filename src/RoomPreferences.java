...
public class RoomPreferences {
    ...
    public RoomPreferences(RoomType preferredRoomType, int preferredFloor,
                           boolean smokingAllowed, boolean seaView) {
    ...
    public String toString() {
        return "RoomPreferences{type=" + preferredRoomType +
